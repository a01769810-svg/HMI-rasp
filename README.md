...
└── docs/
    ...
    ├── MODBUS_TCP_PROFUNDO.md        ← Modbus TCP a fondo: frame, FCs, encoding 32-bit/float, cliente+servidor pymodbus, driver OTE, buenas prácticas, mapa Modbus de la celda
